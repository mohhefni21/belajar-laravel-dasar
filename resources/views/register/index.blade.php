    ...
    <div class="row justify-content-center">
        <div class="col-lg-4">
            <main class="form-registration w-100 m-auto mt-5">
                <h1 class="h3 mb-3 fw-normal text-center">Registrstion Form</h1>
                ...
                <small class="d-block mt-2 text-center">Have Accout? <a href="/login" class="text-decoration-none">Login now</a></small>
            </main>
        </div>
    </div>
</div>
