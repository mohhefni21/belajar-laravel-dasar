...
<form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
  @method('put')
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $post->slug) }}" readonly style="background-color:#e0e0eb">
      @error('slug')
        <div class="invalid-feedback">
          {{ $message }}
        </div>
    ...
    <div class="mb-3">
      ...
      @if ($post->image)
        <img class="img-preview img-fluid mb-2 col-sm-5 d-block" src="{{ asset('/storage/' . $post->image) }}">
      @else
